...
class NinePatch {
  static Container right() => Container(
        ...
        decoration: MyDecoration.only(
            ...
            borderRadius: MyBorderRadius.only(
                topRight: 16.0, topLeft: 16.0, bottomLeft: 16.0)),
        child: MyText(
          "Hello, Hello ,Ghanfadjf ajdfaj\n jkadkfafd fadsfjakdf adsfkadshfjdabfjdabfjadbfjadbfjladfjld daf",
        color: Colors.white,

        ),
      );

  static Container left() => Container(
        margin: MyEdgeInsets.symmetric(h: 16.0, v: 12.0),
        constraints: MyBoxConstraints.box(),
        padding: MyEdgeInsets.all(12.0),
        decoration: MyDecoration.only(
